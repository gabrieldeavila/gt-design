...
import GTSyncedStore from "../../../components/SyncedStore/GTSyncedStore";
...
export default {
  title: "Data Entry/Inputs/Websocket",
};
...
const Template = () => {
  ...
  return (
    <GTBasic>
      <GTSyncedStore name="synced_store">
        <Space.Horizontal>
...
export const Websocket = Template.bind({});
